...
class CrimeDetailFragment : Fragment() {
    ...
    private val crimeDetailViewModel: CrimeDetailViewModel by viewModels {
        CrimeDetailViewModelFactory(args.crimeId, args.toSavedStateHandle())
    }
        ...
        if (didTakePhoto && photoName != null) {
            crimeDetailViewModel.updateCrime { oldCrime ->
                when(crimeDetailViewModel.photoFileNameIndex) {
                    0 -> oldCrime.copy(photoFileName = photoName)
                    1 -> oldCrime.copy(photoFileName2 = photoName)
                    2 -> oldCrime.copy(photoFileName3 = photoName)
                    else -> oldCrime.copy(photoFileName4 = photoName)
                }
            }
